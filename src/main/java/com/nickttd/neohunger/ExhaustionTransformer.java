...
public class ExhaustionTransformer implements IClassTransformer {
    ...
    private byte[] patchEntityPlayer(byte[] basicClass) {
        ...
        cr.accept(new ClassVisitor(Opcodes.ASM4, cw) {
            ...
            public MethodVisitor visitMethod(int access, String name, String desc, String signature,
                ...
                // Patch jump, onLivingUpdate, attackTargetEntityWithCurrentItem, onBlockDestroyed, damageEntity,
                // addMovementStat
                ...
                if (name.equals("attackTargetEntityWithCurrentItem")
                    && desc.equals("(Lnet/minecraft/entity/Entity;)V")) {
                    return new PatchAddExhaustionAdapter(mv, access, name, desc);
                }
                if (name.equals("onBlockDestroyed")
                    && desc.equals("(Lnet/minecraft/world/World;IIIILnet/minecraft/block/Block;)V")) {
                    return new PatchAddExhaustionAdapter(mv, access, name, desc);
                }
    ...
    private static class PatchAddExhaustionAdapter extends AdviceAdapter {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            ...
            if (owner.equals("net/minecraft/entity/player/EntityPlayer") && name.equals("addExhaustion")
                && desc.equals("(F)V")) {
                ...
                if (methodName.equals("onBlockDestroyed")) {
                    ...
                    if (methodName.equals("attackTargetEntityWithCurrentItem") || methodName.equals("damageEntity")) {
